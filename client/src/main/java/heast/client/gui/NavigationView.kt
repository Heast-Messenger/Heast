...
import heast.client.gui.sidebar.ServerSidebarView
import heast.client.gui.sidebar.SettingsSidebarView
import heast.client.gui.template.ViewPane
...
object NavigationView : VBox() {
	...
	class SidebarButton(img: Image, private val content: Node, private val toggleGroup : ToggleGroup? = null, private val onAction: EventHandler<MouseEvent>? = null) : BorderPane() {
